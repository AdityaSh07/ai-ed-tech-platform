...
EduSphere AI is an advanced Ed-Tech platform that empowers students and researchers with cutting-edge AI tools to enhance learning, synthesis, and deep research. 
...
The central hub for all AI tools. Select between the RAG Chatbot, Notes Generator, or Research Agent.
<img src="assets/dashboard.png" alt="Dashboard" width="75%">

### 3. Self-Correcting RAG Chatbot
...
<p align="center">
  <img src="assets/rag_chatbot.png" alt="RAG Chatbot" width="48%">
  <img src="assets/rag_chatbot2.png" alt="RAG Chatbot Structure" width="48%">
</p>

### 4. AI Notes Synthesis Workspace
Convert long papers, books, or syllabuses into clean, summarized markdown concept logs. The Notes Generator extracts chunked knowledge and provides structured outputs.
...
<p align="center">
  <img src="assets/note_creation.png" alt="Note Creation Upload" width="48%">
  <img src="assets/note_creation%20example.png" alt="Note Creation Example" width="48%">
</p>

### 5. Autonomous Research Agent **(Coming Soon)**
...
<img src="assets/coming%20soon%20research%20agent.png" alt="Research Agent" width="35%" height = "300">
